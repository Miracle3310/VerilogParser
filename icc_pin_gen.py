...
def gen_pin_oneside(pin_list, side: int, idx_start: int, side_pin_num: int):
    ...
    for i in range(idx_start, idx_start + side_pin_num):
        s_cmd = 'set_pin_physical_constrains '
...
def gen_pin(rtl: rtl_parser):
    ...
    gen_pin_line_list.append(gen_pin_oneside(
        pin_list, 0, 0*oneside_pin_num, oneside_pin_num))
    gen_pin_line_list.append(gen_pin_oneside(
        pin_list, 1, 1*oneside_pin_num, oneside_pin_num))
    gen_pin_line_list.append(gen_pin_oneside(
        pin_list, 2, 2*oneside_pin_num, oneside_pin_num))
    gen_pin_line_list.append(gen_pin_oneside(
